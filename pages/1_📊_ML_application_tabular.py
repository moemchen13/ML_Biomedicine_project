...
with tab1:    
    ...
    if st.session_state.json_valid:
        ...
        with preprocess_side:
            ...
            st.download_button(label="Download Preprocessed Data",data=clean_data(df).to_csv(),file_name=f_name)
        ...
        if pipeline_button:
            stats,trained_models, params_trained_models, names_trained_models = ML_Pipeline(df, conf)
